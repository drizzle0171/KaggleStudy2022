...
predictor = dlib.shape_predictor(r'C:\Users\yongs\Downloads\shape_predictor_68_face_landmarks.dat')
...
while cap.isOpened():
    ...
    if len(faces) > 0:
        ...
        face_img = img[y1:y2, x1:x2].copy() #face만 crop하여 face_img에 적용
